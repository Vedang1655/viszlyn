...
export const highestPaidAthletes2026: RankingArticle = {
  slug: "highest-paid-athletes-2026",

  metaTitle: "The 10 Highest-Paid Athletes in 2026 | Viszlyn",
  metaDescription:
  ...
  quickAnswer:
    "Cristiano Ronaldo is the highest-paid athlete in the world for 2026, earning an estimated $300 million \u2014 his highest total yet and his fourth consecutive year at No. 1. The top four alone (Ronaldo, Canelo \u00c1lvarez, Messi, and LeBron James) earned nearly $748 million combined, more than the remaining six spots in the top 10 combined.",
  introParagraph:
    "Athlete earnings have never been more concentrated at the very top, or more shaped by forces outside the field of play. Saudi Arabia's sports investment continues to reshape pay in boxing, golf, and soccer, while off-field endorsements now rival or exceed playing salaries for many of the world's top earners. Forbes' 2026 ranking tracks pretax income from May 1, 2025 through May 1, 2026, covering salaries, prize money, bonuses, and off-field earnings from endorsements, appearances, and business ventures.",

  chartTitle: "Estimated Athlete Earnings \u2014 2026 \u00b7 USD millions",
  chartSource: "Forbes",
  chartTapNote: "Tap any athlete to jump to their full breakdown below.",
  chartItems: [
